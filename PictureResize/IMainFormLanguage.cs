...
{
    public interface IMainFormLanguage
    {
        string Bicubic
        {
            get;
        ...
        string HighQualityBicubic
        {
            get;
        }
        string HighQualityBilinear
        {
            get;
        }
